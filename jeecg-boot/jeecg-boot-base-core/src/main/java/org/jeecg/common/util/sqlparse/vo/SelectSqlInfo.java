...
public class SelectSqlInfo {
    ...
    public SelectSqlInfo(String fromTableName, String fromTableAliasName) {
        this.fromTableName = fromTableName;
        this.fromTableAliasName = fromTableAliasName;
        this.parsedSql = "SELECT * FROM " + fromTableName + (fromTableAliasName == null ? "" : " AS " + fromTableAliasName);
    }
    ...
    public String toString() {
        return "SelectSqlInfo{" +
                ...
                ", fromTableAliasName='" + fromTableAliasName + '\'' +
